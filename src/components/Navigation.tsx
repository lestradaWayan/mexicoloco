...
const Navigation = () => {
    ...
    return (
        <>
            ...
            <motion.div
                className={cn(
                    'navigationContainer fixed top-0 left-0 z-[99] w-screen [transition:all_1s_cubic-bezier(0,.99,.57,.99)] overflow-hidden',
                    {
                        navigationOpen: open
                    }
                )}
            ...
            >
                <nav className="navigation relative top-0 left-0 h-[100svh] w-screen text-black text-[8vw] leading-none font-semibold flex items-start justify-between flex-col py-[max(15svh,6rem)] secondary-font">
                    <a
                        href="/"
                        className="flex flex-col flex-1 justify-center w-full cursor-pointer px-14 relative"
                    >
                        <p>
                    ...
                    <a
                        href="/"
                        className="flex flex-col flex-1 justify-center w-full cursor-pointer px-14 text- relative"
                    >
                        <p>
                            <span className="w-full z-[2] relative">
                                <PerspectiveText
